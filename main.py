...
# Set Bot token
_token = '5873939399:AAGxMLHy_v-KlrnmFM6PEvnz8xXzAzidVBY'
...
def start(update, context):
    context.bot.send_message(chat_id=update.effective_chat.id, text="Yo {} ! Ca cash j'espère. Je suis l'assistant FxF. Je t'aide à obtenir des informations relatifs aux marchés financier.".format(update.effective_user.first_name))
